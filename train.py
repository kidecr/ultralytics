...
results = model.train(data='./ultralytics/cfg/datasets/Anti-UAV.yaml', epochs=200, device=0, batch=32, cache='ram', patience=200, data_mode="RGBT", save_period=100, resume=False)
