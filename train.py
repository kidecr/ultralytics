...
results = model.train(data='./ultralytics/cfg/datasets/Anti-UAV.yaml', epochs=200, device=2, batch=16, cache="ram", patience=20, data_mode="RGB", save_period=10, resume=False)
